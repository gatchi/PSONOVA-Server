...
// - To make this version support DAT, you must fix and re-enable LoadDataFile()
...
// Disabled until fixed (if that ever happens...)
// Dont worry, its not needed as this version doesnt support DAT.
...
#ifdef NO_SQL
	printf ("Sorry but this version of Teth does not support MySQL-less operation.\n");
	printf ("Press [ENTER] to quit.\n");
	gets(dp);
	exit(1);
#endif
